...
This repository hosts a Python Qt6 application for controlling Pixoo devices. Use this guide to develop, test, and contribute changes consistently.

## Project Structure & Module Organization

- `main.py`: Qt6 GUI entry point and app logic.
